...
public class SpiceHalfWave extends JApplet {

	String [] fonts = getToolkit().getFontList(); 
	SpiceHalfWave.MyPane myPane;
	javax.swing.JTextArea jTextArea1;
	JScrollPane areaScrollPane;
	javax.swing.JTextArea spiceArea;
	
	String title = "Half Wave Rectifier";
	String text="";
	String basic = "";
   ...
   //can change
    String[] value1 = { "RL 3 0 1K", "RL 3 0 10K" };
    String[] value2 = {"C1 3 0 0u", "C1 3 0 4.7u", "C1 3 0 47u", "C1 3 0 100u" };
	...
	public void components(){
		 ...
		 myPane = new SpiceHalfWave.MyPane();	
	...
	public class MyPane extends JPanel{
		...
		public void paintComponent(Graphics g) {
			...
			// FOR CIRCUIT AND OUTPUT PANEL
			 ...
			 g.drawString("Circuit / Output", applet_x-100, 20);
			 g.setColor(Color.black);
			 g.setFont(new Font(fonts[3], Font.BOLD, 20));
			 g.drawString(title, (applet_x/2)-110, 20);
			 g.setColor(Color.black);
